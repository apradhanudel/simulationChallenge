...
fig, ax = plt.subplots(figsize=(10, 6))
sns.histplot(final_balances, bins=20, kde=True, edgecolor='black', alpha=0.7, color='steelblue', ax=ax)
...
# Original game histogram using seaborn
sns.histplot(original_final, bins=20, kde=True, edgecolor='black', alpha=0.7, color='steelblue', ax=ax1)
...
# Modified game histogram using seaborn
sns.histplot(modified_final, bins=20, kde=True, edgecolor='black', alpha=0.7, color='purple', ax=ax2)
